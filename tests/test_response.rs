...
fn test_full_response_something_something() {
    ...
    let inputdata = ResponseElementsBuilder::new()
        ...
        .canonicalization_method(saml_rs::sign::CanonicalizationMethod::ExclusiveCanonical10).build().expect("Failed to build ResponseElements for test_full_response_something_something");
